...
urlpatterns = [
    ...
    path("api/v1/recommend/gnn/", include("apps.recommendations.gnn.urls")),
    path("api/v1/recommend/content/", include("apps.recommendations.cbf.urls")),
    path("api/v1/recommend/hybrid/", include("apps.recommendations.hybrid.urls")),
]
