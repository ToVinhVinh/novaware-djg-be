...
from apps.recommendations.cbf.mongo_engine import recommend_cbf_mongo

class Command(BaseCommand):
    help = "Run a single Mongo-native CBF recommendation with ObjectId inputs."
    ...
    def add_arguments(self, parser: CommandParser) -> None:
        ...
        parser.add_argument("--outfile", default="cbf_mongo_result.json")
    ...
    def handle(self, *args, **options) -> str | None:
        ...
        payload: dict[str, Any] = recommend_cbf_mongo(
            user_id=user_id,
