...
class GNNRecommendationEngine(BaseRecommendationEngine):
    ...
    def _train_impl(self) -> dict[str, Any]:
        ...
        try:
            ...
            for epoch in range(num_epochs):
                ...
                loss = -torch.mean(user_emb) - torch.mean(item_emb)
                loss.backward()
                optimizer.step()
    ...
    def _fallback_training(self) -> dict[str, Any]:
        ...
        num_training_samples = num_interactions
        embedding_dim = None
